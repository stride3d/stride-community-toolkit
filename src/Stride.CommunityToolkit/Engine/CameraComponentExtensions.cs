...
public static class CameraComponentExtensions
{
    ...
    public static HitResult Raycast(this CameraComponent camera, ScriptComponent component, Vector2 screenPosition, CollisionFilterGroups collisionGroups = CollisionFilterGroups.DefaultFilter, CollisionFilterGroupFlags collisionFlags = CollisionFilterGroupFlags.DefaultFilter)
    {
        var invertedMatrix = Matrix.Invert(camera.ViewProjectionMatrix);
    ...
    /// <returns></returns>
    // screenPosition or mousePosition
